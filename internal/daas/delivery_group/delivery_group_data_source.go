...
var (
	...
	_ datasource.DataSourceWithConfigure = &DeliveryGroupDataSource{}
)
...
func (d *DeliveryGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	deliveryGroup, httpResp, err := citrixdaasclient.ExecuteWithRetry[*citrixorchestration.DeliveryGroupDetailResponseModel](getDeliveryGroupRequest, d.client)
	if err != nil {
