...
variable "hypervisor_name" {
  ...
  type        = string
  default     = "example-xenserver-hyperv"
}

variable "xenserver_username" {
  description = "Username to the xenserver hypervisor"
  type        = string
}

variable "xenserver_password" {
  description = "Password to the xenserver hypervisor"
  type        = string
  sensitive   = true
}

variable "xenserver_password_format" {
  description = "xenserver password format"
  type        = string
  default     = "PlainText"
}

variable "xenserver_addresses" {
  description = "List of addresses to the xenserver hypervisor in the format of \"http://<IP address or hostname for xenserver>\""
  type        = list(string)
}
...
variable "machine_catalog_name" {
  ...
  type        = string
  default     = "example-xenserver-catalog"
}
...
variable "resource_pool_name" {
  ...
  type        = string
  default     = "example-xenserver-rp"
}

variable "xenserver_networks" {
  description = "List of network names for the Resource Pool to use"
  type        = list(string)
}

variable "xenserver_storage_name" {
  description = "Name of the storage"
  type        = string
}

variable "xenserver_temporary_storage_name" {
...
variable "xenserver_resource_location_id" {
  description = "The resource location id of the XenServer resource location for creating zone, which should have connector(s) provisioned."
  type        = string
  default     = ""
}
