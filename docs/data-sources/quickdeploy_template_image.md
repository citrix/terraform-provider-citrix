...
description: |-
  Data Source of a Flex Azure image. Note that this feature is in Tech Preview.
---
...
- `subscription_name` (String) The name of the Flex Azure subscription the image was imported to.
