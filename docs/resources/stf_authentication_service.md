...
- `auth_service_protocol` (Attributes) StoreFront --- Authentication Service Protocol. (see [below for nested schema](#nestedatt--auth_service_protocol))
...
<a id="nestedatt--auth_service_protocol"></a>
### Nested Schema for `auth_service_protocol`

Required:

- `name` (List of String) Names of the Authentication Service Protocol to be added.
