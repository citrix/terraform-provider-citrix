...
description: |-
  Manages a Flex Azure image. Note that this feature is in Tech Preview.
---
...
- `subscription_name` (String) The name of the Flex Azure subscription to import the image. Defaults to `Citrix Managed` if omitted.
